...
pub struct PipelineResult {
    /// C output (if target was C).
    pub c_output: Option<COutput>,
    /// Native module (if target was Native/LlvmIr).
    pub native_output: Option<NativeModule>,
    /// The final LCNF module (always available).
    pub lcnf_module: LcnfModule,
    /// Pipeline statistics.
    pub stats: PipelineStats,
}
/// Worklist for PipeExt.
#[allow(dead_code)]
#[derive(Debug, Clone)]
...
/// Aggregate statistics for the entire pipeline.
#[derive(Debug, Clone, Default)]
pub struct PipelineStats {
    /// Per-pass statistics.
    pub per_pass: Vec<(PassId, PassStats)>,
    /// Total time for the pipeline in microseconds.
    pub total_time_us: u64,
    /// Number of fixed-point iterations executed.
    pub iterations: usize,
    /// Total number of LCNF declarations at input.
    pub input_decls: usize,
    /// Total number of LCNF declarations at output.
...
/// Pass execution phase for PipeExt.
#[allow(dead_code)]
#[derive(Debug, Clone, PartialEq, Eq, Hash)]
...
pub struct PipelineConfig {
    ...
    pub debug: bool,
    /// Whether to emit intermediate IR for inspection.
    pub emit_ir: bool,
    /// Explicit list of passes to run (overrides opt_level if non-empty).
    pub passes: Vec<PassId>,
    /// Maximum iterations for fixed-point optimization.
    pub max_iterations: usize,
    /// Whether to emit comments in generated code.
...
/// Configuration for PipeX2 passes.
#[allow(dead_code)]
#[derive(Debug, Clone)]
